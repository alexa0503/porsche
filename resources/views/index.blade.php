...
<div class="abs game-main-stt">
    <div class="abs n2" >
        ...
        <!--<div class="abs bg" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n2_bg.png" /></div>-->
        ...
        <div class="abs btn-start css-btn css-btn-alpha" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n2_btn-start.png" /></div>
    </div>
    <div class="abs n3" >
        <div class="abs n3-bg" ></div>
        <div class="abs bg-light" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_bg-light.png" /></div>
        <div class="abs btn-1 css-btn" >
            <div class="abs bg" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_btn-1_bg.png" /></div>
            <div class="abs no-sel" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_btn-1_no-sel.png" /></div>
            <div class="abs sel" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_btn-1_sel.png" /></div>
            <div class="abs txt" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_btn-1_txt.png" /></div>
        </div>
        <div class="abs btn-2 css-btn" >
            <div class="abs bg" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_btn-2_bg.png" /></div>
            <div class="abs no-sel" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_btn-2_no-sel.png" /></div>
            <div class="abs sel" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_btn-2_sel.png" /></div>
            <div class="abs txt" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_btn-2_txt.png" /></div>
        </div>
        <div class="abs title" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_title.png" /></div>
        <div class="abs btn-sure css-btn css-btn-alpha" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n3_btn-sure.png" /></div>
    </div>
    <div class="abs n4" id="hitarea">
        ...
        <div class="abs txt-top" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_txt-top.png" /></div>
        <div class="abs n4n1" >
            <div class="abs mask" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_n1_mask.png" /></div>
            <div class="abs face" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_n1_face.png" /></div>
            <div class="abs light" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_n1_light.png" /></div>
            <div class="abs dots" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_n1_dots.png" /></div>
        </div>
        <div class="abs n4n2" >
            <div class="abs mask" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_n2_mask.png" /></div>
            <div class="abs face" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_n2_face.png" /></div>
            <div class="abs light" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_n2_light.png" /></div>
            <div class="abs dots" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_n2_dots.png" /></div>
            <!--<div id="logInfo" style="z-index:1100;color:#fff;"></div>-->
        </div>
        <div class="abs txt-bottom" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_txt-bottom.png" /></div>
        <!--<div class="abs btn-photo css-btn" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_btn-photo.png" /></div>-->
        <div class="abs title" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_title.png" /></div>
        <div class="abs btns" >
            <div class="abs btns_frm_pct" > </div>
            <div class="abs btn-sure   css-btn css-btn-alpha" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_btns_btn-sure.png" /></div>
            <div class="abs btn-upload css-btn css-btn-alpha" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n4_btns_btn-upload.png" /></div>
        </div>
    </div>
    <div class="abs n5" >
        <!--face1--->

        <div class="abs layer_189 face1m" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/face1_m_bg.jpg" /></div>
        <div class="abs layer_189 face1f" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/face1_f_bg.jpg" /></div>

        <!--face1 STT--->
        <div class="abs male" id="pre-male" >
            <div class="abs male-bg" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="face/male_male-bg.png" /></div>
            <div class="abs male-face" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="face/male_male-face.png" /></div>
        </div>
        <div class="abs female" id="pre-female" >
            <div class="abs female-bg" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="face/female_female-bg.png" /></div>
            <div class="abs female-face" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="face/female_female-face.png" /></div>
        </div>
        <!--face1 END--->

        <div class="abs black" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n5_black.png" /></div>
        <div class="abs btns_"  style="z-index:2000;">
            <div class="abs btns_frm_pct" > </div>
            <div class="abs btn-again css-btn css-btn-alpha" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n5_btns__btn-again.png" /></div>
            <div class="abs bnt-sure  css-btn css-btn-alpha" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n5_btns__bnt-sure.png" /></div>
        </div>
    </div>
</div>
...
<div class="abs game-main-body">
    ...
    <div class="abs n6 movie" >
        <div class="abs bg" ><!--<img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n6-movie_bg.png" />--></div>
        <div class="abs timeline"></div>
    </div>
    <div class="abs n7 movie" >
        <div class="abs bg" ><!--<img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n7-movie_bg.png" />--></div>
    </div>
    <div class="abs n8" >
        <div class="abs bg" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n8_bg.jpg" /></div>
        <div class="abs icons" >
            <div class="abs icons_frm_pct" > </div>
            <div class="abs txt" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n8_icons_txt.png" /></div>
            <div class="abs phone" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="{{cdn('images/turnleft.gif')}}" /></div>
        </div>
    </div>
    <div class="abs n9" >
        <div class="abs bg" ><!--<img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n9-movie_bg.png" />--></div>
    </div>
    <div class="abs n10" >
        <div class="abs bg" ><!--<img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n10-movie_bg.png" />--></div>
    </div>
    <div class="abs n11" >
        <div class="abs bg" ><!--<img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n11_bg.png" />--></div>
        <div class="abs arrow" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n11_arrow.png" /></div>
        <div class="abs icons" >
            <div class="abs icons_frm_pct" > </div>
            <div class="abs txt" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n11_icons_txt.png" /></div>
            <div class="abs hand" >
                <div class="abs hand-gif" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="{{cdn('images/click.gif')}}" /></div>
                <!--<div class="abs hand" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n11_icons_hand_hand.png" /></div>
                <div class="abs circle-inner" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n11_icons_hand_circle-inner.png" /></div>
                <div class="abs circle-out" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n11_icons_hand_circle-out.png" /></div>-->
            </div>
        </div>
        <div class="abs hotarea" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/n11_hotarea.png" /></div>
    </div>

    <div class="abs movie" >
        <div class="abs bg" ><!--<img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/movie_bg.png" />--></div>
        <div class="abs black-mask" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/movie_black-mask.png" /></div>
        <div class="abs scan-cartoon_mid" >
            <div class="abs bg" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/movie_scan-cartoon_mid_bg.png" /></div>
            <div class="abs title1" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/movie_scan-cartoon_mid_title1.png" /></div>
            <div class="abs title2" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/movie_scan-cartoon_mid_title2.png" /></div>
        </div>
    </div>
</div>
...
<div class="abs game-main-end">
    <div class="abs last" >
        ...
        <div class="abs note" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/last_note.png" /></div>
        <div class="abs arrow" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/last_arrow.png" /></div>
    </div>
    <div class="abs qrcode" >
        <!--<div class="abs bg" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/qrcode_bg.png" /></div>-->
        <div class="abs black-70" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/qrcode_black-70.png" /></div>
        <div class="abs layer_1" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/qrcode_layer_1.png" /></div>
    </div>
    <div class="abs share" >
        <div class="abs black-90" ><!--<img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/share_black-90.png" />--></div>
        <div class="abs timeline"></div>
        <div class="abs txt" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/share_txt.png" /></div>
    </div>
    <div class="abs share-out" >
        <div class="abs bg" >
        </div>
        <div class="abs photo" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/share-out_photo.png" /></div>
        <div class="abs title" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/share-out_title.png" /></div>
        <div class="abs btn-start" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/share-out_btn-start.png" /></div>
    </div>


    <!--	<div class="abs music" >
    <div class="abs music-on_" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/music_music-on_.png" /></div>
    <div class="abs music-off" ><img class="ptimg" src="{{cdn('images/empty.png')}}" original-data="pec/music_music-off.png" /></div>
</div>-->
