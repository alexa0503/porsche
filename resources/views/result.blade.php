...
<div class="abs game-main-end">
	<div class="abs last share-out" >
	  ...
	  <div class="abs btn-start" onclick="window.location.href='index.html';"><img class="ptimg" src="/images/empty.png" original-data="/pec/share-out_btn-start.png" /></div>
