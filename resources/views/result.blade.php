...
<div class="abs game-main-end">
	<div class="abs last share-out" >
	 ...
	 <!--<div class="abs btn-start" onclick="window.location.href='/';"><img class="ptimg" src="{{cdn('/images/empty.png')}}" original-data="{{cdn('/pec/share-out_btn-start.png')}}" /></div>-->
       <a href="/"><div class="abs btn-start"><img class="ptimg" src="{{cdn('/images/empty.png')}}" original-data="{{cdn('/pec/share-out_btn-start.png')}}" /></div></a>
